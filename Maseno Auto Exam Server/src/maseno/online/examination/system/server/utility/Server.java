...
import maseno.online.examination.system.client.utility.Carrier;
import maseno.online.examination.system.client.utility.CarrierType;
...
import maseno.online.examination.system.server.bean.tables.QuestionManager;
import maseno.online.examination.system.server.bean.tables.StudentManager;
            ...
            while (true) {
                ...
                switch (fromClient.getType()) {
                    case LOGIN_REQ:
                        ...
                        System.out.println("Reply(LOGIN) carrier sent...");
                        break;
                    ...
                    case QUESTION_LIST:
                        ...
                        outToClient.writeObject(toClient);
                        System.out.println("Reply(QUESTION LIST) carrier sent...");
                        break;
                    ...
                    case ANSWERS:
                        ...
                        outToClient.writeObject(toClient);
                        System.out.println("Reply(RESULTS) carrier sent...");
                        break;
                    ...
                    case RESULT:
                        ...
                        outToClient.writeObject(toClient);
                        System.out.println("Reply(RESULTS_REQUEST) carrier sent...");
                        break;
                        default: 
                            break;
                }
