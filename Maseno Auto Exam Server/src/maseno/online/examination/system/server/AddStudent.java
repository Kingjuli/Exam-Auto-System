...
public class AddStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("MASENO Examination Center - Add Student");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if(checkEmptyFields()) {
            ...
            if (String.valueOf(pwPassword.getPassword()).equals(String.valueOf(pwConfirm.getPassword()))) {
                stdBean.setStudentName(txtName.getText());
                stdBean.setUserName(txtUsername.getText());
                String password = Helper.toMD5(String.valueOf(pwPassword.getPassword()));
                stdBean.setPassword(password);

                StudentManager.insertStudent(stdBean);
                JOptionPane.showMessageDialog(null, "New Student added Succesfully", "Add Student", JOptionPane.INFORMATION_MESSAGE);
                this.clearFields();
            } else {
                JOptionPane.showMessageDialog(null, "Please retype password correctly.", "Add Student", JOptionPane.WARNING_MESSAGE);
            }
            
        } else {
            JOptionPane.showMessageDialog(null, "Please fill in all fields.", "Add Student", JOptionPane.WARNING_MESSAGE);            
        }
