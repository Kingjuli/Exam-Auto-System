...
import maseno.online.examination.system.client.utility.Answer;
import maseno.online.examination.system.client.utility.Client;
import maseno.online.examination.system.client.utility.CountdownTimer;
 ...
 */
public class ReviseExamWindow extends javax.swing.JFrame {
    ...
    public ReviseExamWindow(Student std) {
        loggedin = std;
        initComponents();
        setIcon();

        questions = Client.requestQuestionList();
        populate();
    }
    //CountdownTimer.start(lblTimer, 600);

    public ReviseExamWindow(Student std, LinkedList<Question> quiz) {
        this.loggedin = std;
        initComponents();
        setIcon();
    ...
    public void populate() {
        ...
        markbtn.setText("Correct Answer: " + initQustion.getCorrectAns());
    ...
    private void initComponents() {
        ...
        markbtn = new com.alee.laf.button.WebButton();
        ...
        setTitle("MASENO Examination Center - Take Examination");
        ...
        btnNext.setIcon(new javax.swing.ImageIcon(getClass().getResource("/maseno/online/examination/system/client/images/next.png"))); // NOI18N
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel3Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addComponent(lblAns1, javax.swing.GroupLayout.PREFERRED_SIZE, 256, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(8, 355, Short.MAX_VALUE)))
                .addContainerGap())
        );

        jPanel3Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {radAns3, radAns4});

        jPanel3Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {lblAns2, lblAns3, lblAns4});
        ...
        btnBack.setIcon(new javax.swing.ImageIcon(getClass().getResource("/maseno/online/examination/system/client/images/back.png"))); // NOI18N
        ...
        btnFinish.setIcon(new javax.swing.ImageIcon(getClass().getResource("/maseno/online/examination/system/client/images/tick.png"))); // NOI18N
        btnFinish.setText("   Finish Revision");
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/maseno/online/examination/system/client/images/QuestionWindow.png"))); // NOI18N
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextActionPerformed
        ...
        count++;
        if (count > 5) {
            JOptionPane.showMessageDialog(null, "You revised all the questions for this examination.", "Revise Examination", JOptionPane.INFORMATION_MESSAGE);
            questionIdx--;
        } else {
            ...
            markbtn.setText("Correct Answer: " + question.getCorrectAns());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReviseExamWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ReviseExamWindow(null).setVisible(true);
            }
        });
    }
    ...
    private com.alee.laf.button.WebButton markbtn;
